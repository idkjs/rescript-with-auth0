...
@bs.module("expo-local-authentication")
external supportedAuthenticationTypesAsync: unit => Js.Promise.t<
  array<AuthenticationType.t>,
...
@bs.module("expo-local-authentication")
external authenticateAsync: authenticateAsyncOptions => Js.Promise.t<
